...
let post = async (req,res) =>{
    try{
        let data1 = [req.body]
        const query1 = "INSERT INTO offer set ? "
...
let patch = async (req,res) => {
    try{
    let data2 = [req.body , req.params.offer_id]
    query2 = "UPDATE offer SET ? WHERE offer_id = ? "
...
let del = async (req,res) =>{
    ...
    let query2 = "DELETE FROM offer WHERE offer_id = ?"
